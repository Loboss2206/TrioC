...
int main()
{
    ...
    {
        if (choixMenu == 1)
        /// version 1 : on parcours la grille jusqu'à trouver les valeurs qui correspondent à la cible
        {
        ...
        /// version 2 : on génère tous les calculs possibles présents dans la grille, on les tri par
